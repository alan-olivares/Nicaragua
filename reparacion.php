  ...
  <script src="js/revisar_sesion.js"></script>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="reparacion.php">Barriles reparados</a></li>
                    </ul>
                </li>
        ...
        <div class="navbar-header">
            ...
            <h2 class="nav navbar-top-links navbar-right">Registro de barriles reparados</h2>
            ...
            <div class="row wrapper border-bottom white-bg page-heading" >
              ...
              <div class="col-md-6 text-center" >
                ...
                <button class="button2 btn btn-primary" onclick="exportTableToCSV('Reporte Reparacion '+dia+'.csv')">CSV</button>
              </div>
              <script type="text/javascript">
              document.getElementById("date1").valueAsDate= new Date();
              </script>
              <?php include'connection_reparacion.php'?>
            </div>
        ...
        $(document).ready(function(){
            $('#tabla1').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'csv',text:'CSV',title: 'Reporte Reparacion',footer:true,customize: function (csv) {
                    ...
                    {extend: 'excel',text:'Excel', title: 'Reporte Reparacion',footer:true},
                    {extend: 'pdf',text:'PDF', title: function(){ return "Reporte Reparacion";},
          ...
          buttons: [
              { extend: 'copy',text:'Copiar'},
              {extend: 'csv',text:'CSV',title: 'Reporte Detalle Reparacion',footer:true,customize: function (csv) {
                var buffer = new ArrayBuffer(3);
                var dataView = new DataView(buffer);
                dataView.setUint8(0, 0xef);
                dataView.setUint8(1, 0xbb);
              ...
              {extend: 'excel',text:'Excel', title: 'Reporte Detalle Reparacion',footer:true,customize: function( xlsx ) {

                var sheet = xlsx.xl.worksheets['sheet1.xml'];
                //list of columns that should get a 1000 separator depending on local Excel installation
                $('row c[r^="A"]', sheet).attr( 's', '' );
              }},
              {extend: 'pdf',text:'PDF', title: function(){ return "Reporte Detalle Reparacion";},
              footer:true,customize:function(doc){
                doc.styles.tableHeader.fillColor='#1ab394';
                doc.styles.title.alignment='left';
                doc.styles.tableFooter.fillColor='#1ab394';
