  ...
  <script src="js/revisar_sesion.js"></script>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="llenados.php">Barriles llenados</a></li>
        ...
        <div class="navbar-header">
            ...
            <h2 class="nav navbar-top-links navbar-right">Registro de barriles por llenado</h2>
            ...
            <div class="row wrapper border-bottom white-bg page-heading" >
              ...
              <div class="col-md-5 text-center" >
                ...
                <button class="button2 btn btn-primary" onclick="exportTableToCSV('Barriles llenados.csv')">CSV</button>
              </div>
              <script type="text/javascript">
              document.getElementById("date1").valueAsDate= new Date();
              document.getElementById("date2").valueAsDate= new Date();
              </script>
              <?php include'connection_llenados.php'?>
            </div>
    ...
    $('.datas .input-group.date').datepicker({
        todayBtn: "linked",
    ...
    function limpiar() {
      ...
      window.location.replace("login.php");
        ...
        buttons: [
            ...
            {extend: 'csv',text:'CSV',title: 'Reporte Llenado',customize: function (csv) {
            ...
            {extend: 'excel',text:'Excel', title: 'Reporte Llenado',footer:true, customize: function( xlsx ) {
            ...
            {extend: 'pdf',text:'PDF', title: function(){ return "Reporte Llenado";},
    ...
    $('#tabla1').DataTable({
        ...
        buttons: [
            { extend: 'copy',text:'Copiar'},
            {extend: 'csv',text:'CSV',title: 'Reporte Detalle Llenado',footer:true,customize: function (csv) {
              var buffer = new ArrayBuffer(3);
              var dataView = new DataView(buffer);
              dataView.setUint8(0, 0xef);
              dataView.setUint8(1, 0xbb);
            ...
            {extend: 'excel',text:'Excel', title: 'Reporte Detalle Llenado',footer:true,customize: function( xlsx ) {
            ...
            {extend: 'pdf',text:'PDF', title: function(){ return "Reporte Detalle Llenado";},
            footer:true,customize:function(doc){
              doc.styles.tableHeader.fillColor='#1ab394';
              doc.styles.title.alignment='left';
              doc.styles.tableFooter.fillColor='#1ab394';
